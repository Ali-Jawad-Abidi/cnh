...
//               <h5 className="text-xl whitespace-pre-line tracking-tight text-gray-700 dark:text-white flex-grow">
//                 {props.item.title}
//               </h5>
//             </div>
//           </Link>
...
export function EcomCard(props) {
  return (
    <div className="group border-gray-700 dark:border-white max-h-[65vh] shadow flex w-full max-w-xs flex-col self-center overflow-hidden rounded-lg border bg-white shadow-md dark:bg-gray-700">
      ...
      >
        <img
          className="peer absolute top-0 right-0 h-full w-full object-cover hover:z-20 hover:scale-110"
          src={props.item.thumbnail}
          alt="product image"
        />
      </Link>
      <div className="mt-2 px-2 pb-2">
        ...
        >
          <div className="flex flex-col h-full">
            <h5 className="text-xl tracking-tight text-gray-700 dark:text-white overflow-hidden overflow-ellipsis h-16">
              {props.item.title}
            </h5>
          </div>
        </Link>
        <div className="flex flex-col items-center justify-between">
          ...
          >
            <div className="hover:border-white/40 focus:bg-green-700 cursor-pointer flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-2 h-6 w-6"
                fill="none"
...
export function ProductsGrid(props) {
  ...
  //   }
  // };
  if (merch.length < 1) return <Spinner />;
  return (
    <>
      ...
      <div className="flex flex-row gap-4 min-h-full min-w-screen pl-4 mt-4">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="mx-auto">
            {showMore && (
              <div className="mx-auto pt-2 pb-2 justify-center w-full">
                <button
                  onClick={() => {
                    fetchMerch();
                  }}
                  className="button px-12 whitespace-nowrap py-3 bg-blue-700 rounded-lg lg:rounded-xl shadow-bg-blue-700 shadow-2xl text-white flex justify-center cursor-pointer hover:opacity-60"
                >
                  Show More
                </button>
              </div>
